...
# A thought - given the sequence composition of UTRs, can we predict how often we 
# would expect there to be an ATG at random? We can then look at depletion against 
# this for different gene sets?
