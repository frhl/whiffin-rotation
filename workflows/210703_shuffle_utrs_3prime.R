...
fwrite(res_mat_obs, 'derived/210707_MANE.GRCh38.v0.95_three_prime_utr_codons_obs.csv', sep = ',')
...
res <- lapply(1:replicates, function(i){
  ...
  outfile_ci <- paste0('derived/210707_MANE.GRCh38.v0.95_three_prime_utr_codons_expt_ci_rep',i,'.csv')
  ...
  # save only estimates
  outfile_est <- paste0('derived/210707_MANE.GRCh38.v0.95_three_prime_utr_codons_expt_rep',i,'.csv')
